...
| A-024 | درخواست فعال دامپزشک با محدودیت پذیرش کار جدید قابل ادامه است. | PROMPT-005, PROMPT-007, PROMPT-018, PROMPT-019 | PARTIAL(PROMPT-005) — قاعده کامل: عضویت غیرفعال کار جدید و حضور در Finder را می‌بندد و کار فعال قبلی را باز می‌گذارد؛ نقش و Location حفظ می‌شود. اتصال به صف واقعی در PROMPT-007 |
